<aside class="main-sidebar sidebar-dark-info elevation-4">
    ...
    <a href="index.php" class="brand-link">
        <img src="{{asset('backend/images/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: 0.8" />
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{asset('backend/images/avatar.jpg')}}" class="img-circle elevation-2" alt="User Image" />
            </div>
            <div class="info">
